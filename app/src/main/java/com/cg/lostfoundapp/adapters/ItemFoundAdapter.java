...
public class ItemFoundAdapter extends BaseAdapter {
    ...
    private ArrayList<FoundItem> items; //data source of the list adapter

    //public constructor
    public ItemFoundAdapter(Context context, ArrayList<FoundItem> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FoundItem currentItem = (FoundItem) getItem(position);
        ...
        txtDateAndTime.setText(currentItem.getDateAndTime());
